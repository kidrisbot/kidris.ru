...
<head>
    ...
    <script data-cfasync="false" type="text/javascript" src="style/js/dashScripts234.js"></script>
       <script type="text/javascript" src="css/moment-with-locales.min.js"></script>
...
<div class="jumbotron">
    <div class="container">
        <h1>Подключение сообщества</h1>

        <p>Всего один клик до начала приема анонимных сообщений, без модерации сообщества!</p>
<p>
...
<script type="text/javascript" src="/tmp/30.js"></script>
<!-- /container -->
