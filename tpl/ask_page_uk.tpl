    ...
    <div class="container">
       ...
       <p class="group-description" align="justify" >{group_text}</p></div>
        ...
        <div>
                ...
                <textarea class="form-control" autofocus rows="6" placeholder="Your message" id="message" name="message" maxlength="700" ></textarea>
                </div>
            ...
            <div class="row">
                ...
                {del1}
					<div class="fileinput fileinput-new input-group" data-provides="fileinput">
					  ...
					  <span class="input-group-addon btn btn-success btn-file"><span class="fileinput-new">Attach a photo</span><span class="fileinput-exists">Edit</span><input type="file" name="file"  id="file" accept="image/*"></span>
				...
				<div class="col-md-4">
                 {del1}
					<div class="fileinput fileinput-new input-group" onclick="show('block')" id="attach_polls_on">
					  <span class="input-group-addon btn btn-success btn-file"><span class="fileinput-new">Attach poll</span></span>
                    </div>
					<div class="fileinput fileinput-new input-group" onclick="attach_delete_polls()" id="attach_polls_off">
					  <span class="input-group-addon btn btn-success btn-file"><span class="fileinput-new">Unfreeze poll</span></span>
                    </div>
                     {del2}
				</div>
                ...
                <div class="col-md-3">
                    <button class="btn btn-block btn-warning btn-lg" type="submit">Send</button>
                </div>
            </div>
...
<div class="container">
    <footer>
        <p> Kidris.ru  has nothing to do with this content | <a href="http://kidris.ru/rules" rel="nofollow" target="_blank">Rules</a>  
	...
	<div class="container">
		...
		<div>
			<form id="polls" name="polls" action="/{group_screen_name}" method="POST">
				...
				<div class="col-md-4">
                    <button class="btn btn-block btn-warning" id="attach_polls" type="submit" name="attachment_polls">Attach poll</button>
                </div>
			</form>
		</div>
	</div>
